      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-3 mb-6">
            <div className="w-12 h-12 bg-gradient-to-br from-sky-700 to-sky-900 rounded-lg flex items-center justify-center shadow-lg">
              <Anchor className="w-7 h-7 text-white" />
            </div>
            <div className="flex flex-col">
              <span className="text-2xl font-bold text-sky-900 leading-tight">CV BUILD</span>
              <span className="text-sm font-semibold text-sky-700 -mt-1">FOR SEAMAN</span>
            </div>
          </Link>
          ...
          <p className="text-gray-600">
            {isLogin ? 'Log in to access your maritime CVs' : 'Join thousands of seafarers'}
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Input
                id="email"
                type="email"
                placeholder="your.email@maritime.com"
            ...
            {isLogin && (
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm text-sky-700 hover:text-sky-900 font-medium">
                  Forgot password?
                </a>
              </div>
            )}
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <button
                ...
                className="ml-2 text-sky-700 hover:text-sky-900 font-semibold"
              >
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          ...
          <a href="#" className="text-sky-700 hover:text-sky-900">Terms of Service</a>
          {' '}and{' '}
          <a href="#" className="text-sky-700 hover:text-sky-900">Privacy Policy</a>
        </p>
      </div>
    </div>
  );
