              ...
              <div className="space-y-3 text-sm">
                ...
                {cvData.personalInfo.linkedin && (
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="break-words text-xs">{cvData.personalInfo.linkedin}</p>
                    </div>
                  </div>
                )}
                ...
                {cvData.personalInfo.facebook && (
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="break-words text-xs">{cvData.personalInfo.facebook}</p>
                    </div>
                  </div>
                )}
                ...
                {cvData.personalInfo.instagram && (
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="break-words text-xs">{cvData.personalInfo.instagram}</p>
                    </div>
                  </div>
                )}
                ...
                {cvData.personalInfo.twitter && (
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="break-words text-xs">{cvData.personalInfo.twitter}</p>
                    </div>
                  </div>
                )}

                {cvData.personalInfo.youtube && (
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex-1">
                      <p className="break-words text-xs">{cvData.personalInfo.youtube}</p>
                    </div>
                  </div>
                )}
              </div>
